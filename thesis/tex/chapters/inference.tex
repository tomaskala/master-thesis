...
The remaining step is the choice of the importance sampling distribution $q(\bm{x})$. Obviously, the more similar this distribution is to the target $p(\bm{x})$, the closer approximation we obtain.
