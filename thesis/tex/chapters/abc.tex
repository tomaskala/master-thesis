...
{\color{red} TODO: Start refactoring here. Describe the algorithm in words, then nicely follow with the likelihood estimate.}

As given in \cite{jasra-time-series}, the likelihood $p(\by_{1:T} \mid \btheta)$ is then approximated as
\begin{equation*}
